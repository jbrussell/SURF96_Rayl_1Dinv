...
% % Colors
% clrs = [50 1 1; 224 0 0; 242 222 0; 255 255 255; 120 204 145; 0 157 219; 88 23 137; 70 17 109]/255;

% Positions
pos01 = [0    0.1667    0.3333    0.5000    0.6667    0.85 0.95 1.0000];
% Colors
clrs = [50 1 1; 224 0 0; 242 222 0; 255 255 255; 120 204 145; 0 157 219; 88 23 137; 70 17 109]/255;
